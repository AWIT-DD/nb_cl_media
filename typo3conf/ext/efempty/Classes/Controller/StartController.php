<?php
namespace Typovision\Efempty\Controller;
...
class StartController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function indexAction() {
		...
		// object assign
		$start = new \Typovision\Efempty\Domain\Model\Start();
        ...
        $obj = array();
        for ($i=1; $i<=3; $i++) {
            $start = $this->objectManager->get('\\Typovision\\Efempty\\Domain\\Model\\Start');
